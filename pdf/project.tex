...
\subsection{Monte-Carlo Integration}
  ...
  % DONE - Explain the implementation of expected value (and online mean, variance)
  % DONE - explain random number generator used + reference paper
  % DONE - explain set of random seeds used and where they originate from
  % DONE - mention parallel runtime implementation

  % DONE - explain that we use rejection and how it's a trade of from using transformation method
