...
\label{sec:verify}
  ...
  To investigate the numerical stability of the implementation due to inexact floating-point arithmetic
  ...
  \plot{proj-mont-stab}{
    Deviation of results given exact arithmetic for our Monte-Carlo expectation estimator. The error
