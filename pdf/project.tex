...
\section{Results}
  ...
  are in agreement and the most accurate result is \final.
  ...
  The parallelized \is{} implementation takes around $25-30$ns per sample. To achieve $\epsilon \le 10^{-6}$
  at $2\sigma$ confidence $\sim 10^{12}$ samples are required or about $\sim 6$ hours of runtime\footnotemark.
  ...
  \begin{tabular}{ l | l l l l }
    ...
    Slanted \is & $0.49765521455387013$ & $2.695543800022229\times10^{-05}$      & $99991552$ & $2.89$s    \\
  ...
  \footnotetext{
    ...
    $\pi = |\Psi|^2$ is normalized $\epsilon = |Z-\bar Z|$.
  }
